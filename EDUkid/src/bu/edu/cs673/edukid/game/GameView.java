...
public class GameView extends Activity {
	...
	// Store letter for the question
	private int MainID;

	// Array containing the letters for each button
	private int[] letterTracker = { -1, -1, -1, -1 };
	...
	public void setQuestions() {
		...
		for (int i = 0; i < 4; i++) {
			...
			case 0:
				imageID = categoryType.getLearnItemDrawableId(option, 0);
